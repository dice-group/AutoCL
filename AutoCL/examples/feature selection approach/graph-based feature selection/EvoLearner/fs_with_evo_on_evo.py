...
DIRECTORY = './ICML/FINAL/FS_WITH_EVO_USING_EVO/'
...
if __name__ == "__main__":
    ...
    for str_target_concept, examples in settings['problems'].items():
        ...
        with open(f'{DIRECTORY}{DATASET}_featureSelection.txt', 'a') as f:
            ...
            print('Time Taken for Feature selection:', elapsed_time, file=f)
            print('Time Taken for Running fit and predict:', elapsed_time_2, file=f)
            print('=============================================', file=f)
