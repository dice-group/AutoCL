...
DIRECTORY = './FsSklearnCeloeAndHpo/'
LOG_FILE = 'feature_selection_with_sklearn.log'
DATASET = 'mammograph'
...
if __name__ == "__main__":
    ...
    for str_target_concept, examples in settings['problems'].items():
        ...
        wrap_obj = celoeWrapper(knowledge_base=kb_with_selected_features,
        ...
        with open(f'{DIRECTORY}{DATASET}_feature_selection_with_sklearn.txt', 'a') as f:
            ...
            print('best_hpo-maxruntime', best_hpo['max_runtime'].values[0], file=f)
            ...
            print('---------------------------', best_hpo['quality_func'].values[0], file=f)