...
DIRECTORY = './FsSklearnEvolearner/'
LOG_FILE = 'feature_selection_with_sklearn_evolearner_and_hpo.log'
DATASET = 'mammograph'
...
if __name__ == "__main__":
    ...
    for str_target_concept, examples in settings['problems'].items():
        ...
        with open(f'{DIRECTORY}{DATASET}_feature_selection_with_sklearn_evolearner_and_hpo.txt', 'a') as f:
            ...
            print('Time Taken 2 After selecting the best hpo:', elapsed_time_1, file=f)                
            print('----------------------------', file=f)