...
from evolearner_feature_selection import EvoLearnerFeatureSelection
...
DIRECTORY = './FS_SKLEARN_CELOE/'
LOG_FILE = "feature_selection_sklearn_CELOE.log"
