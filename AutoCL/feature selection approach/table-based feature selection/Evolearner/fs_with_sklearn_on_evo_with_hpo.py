...
if __name__ == "__main__":
    ...
    df = pd.DataFrame(columns=['LP', 'max_runtime', 'tournament_size', 'height_limit', 'card_limit',
                               'use_data_properties', 'quality_func', 'use_inverse_prop', 'value_splitter',
                               'quality_score', 'Validation_f1_Score', 'Validation_accuracy'])
    ...
    for str_target_concept, examples in settings['problems'].items():
        ...
        st3 = time.time()
        wrap_obj = EvoLearnerWrapper(knowledge_base=kb_with_selected_features,
