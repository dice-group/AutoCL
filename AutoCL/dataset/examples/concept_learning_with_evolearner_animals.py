...
try:
    ...
    pass
#the dataset
with open('synthetic_problems_animals.json') as json_file:
      ...
      for c in [1,10]:
       for d in [1,10]:
        for e in [1,10]:
          ...
          model = EvoLearner(knowledge_base=kb,max_runtime=600, tournament_size=a,card_limit=b,population_size=c,num_generations=d,height_limit=e)
         #training
...
df.to_csv('/Users/ljymacbook/Desktop/evolearner-results_animals.csv')
